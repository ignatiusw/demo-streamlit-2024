...
USE ROLE USERADMIN;
-- streamlit creator
CREATE OR REPLACE USER DEMO_STREAMLIT_CREATOR WITH PASSWORD = '<choose your own strong password>';
CREATE OR REPLACE ROLE ROL_DEMO_STREAMLIT_CREATOR;
GRANT ROLE ROL_DEMO_STREAMLIT_CREATOR TO USER DEMO_STREAMLIT_CREATOR;

-- streamlit viewer
CREATE OR REPLACE USER DEMO_STREAMLIT_VIEWER WITH PASSWORD = '<choose your own strong password>';
...
GRANT ALL ON SCHEMA DEMO_PROGRAMMABLE_2024_STREAMLIT_DB.DATA TO ROLE ROL_DEMO_DATA_CRUD;
